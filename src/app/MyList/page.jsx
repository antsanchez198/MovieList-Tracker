...
const MyList = () => {
  ...
  useEffect(() => {
    ...
    const closeBtn = document.getElementById("dialog-btn");
  ...
  const randomMoviePicker = () => {
    if (myMovies.length > 1) {
      ...
      console.log(myMovies.at(Math.floor(Math.random() * myMovies.length)))
    }
  }
  ...
  return (
    <div className="">
      ...
      hover:bg-gradient-to-tr	from-fuchsia-500 to-cyan-500 hover:transition duration-300 ease-in-out hover:shadow-2xl"
        ...
        <form>
          <select name="cars" id="cars" onChange={(e) => handleOnSelect(e)} className="bg-slate-500 w-45 px-1 py-2 text-slate-50 text-lg mt-20 cursor-pointer">
